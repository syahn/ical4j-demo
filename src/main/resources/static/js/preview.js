...
//option variables
    ...
    function requestSave() {
        ...
        $.post("http://localhost:9000/convert", optionValue)
            .done(function () {
    ...
    //미리보기 세로방향, 가로방향 보여주기
    function changePreviewByOrientation() {
